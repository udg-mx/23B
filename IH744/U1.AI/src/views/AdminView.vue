<template>
  ...
  <ConfirmModal :isOpen="isModalOpen" @confirm="handleConfirm" @cancel="handleCancel" title="Reestablecer Base de Datos" message="¿Deseas reestablecer la base de datos?" />
