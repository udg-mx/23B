...
export default defineComponent({
  ...
  setup() {
    ...
    const currentContext = ref<string | number>("");

    const handleRemove = (postId: string|number) => {
      currentContext.value = postId as string;
    ...
    const handleConfirm = () => {
      // convert to number
      const postID: number = parseInt(currentContext.value as string);
