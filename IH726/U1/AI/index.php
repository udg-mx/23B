...
<section id="wrapper" class="w-full h-full flex items-center justify-center mx-auto">
    ...
    <?php if (!$isLoggedIn): ?>
        ...
        <form action="" method="post" class="bg-white p-6 rounded shadow" style="max-width: 500px;">
            <div class="mb-4">
