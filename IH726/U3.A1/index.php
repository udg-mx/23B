...
if (!file_exists('sessions.json') || !is_file('sessions.json') || !is_writable('sessions.json'))
{
    die("El archivo sessions.json no existe o no tiene permisos de escritura.");
}

$data = json_decode(@file_get_contents('sessions.json'), true) ?? [];
$authID = $_COOKIE['auth_id'] ?? null;
$userData = $data[$authID] ?? [];
session_start();
    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div class="flex items-center lg:order-2">
                ...
                <span class="bg-gray-100 text-gray-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded mr-2 dark:bg-gray-700 dark:text-gray-400 border border-gray-500">U3.A1</span>
